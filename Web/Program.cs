...
builder.Services.AddTransient<IService<Book>, Service<Book>>();
builder.Services.AddTransient<IService<Publisher>, Service<Publisher>>();
builder.Services.AddTransient<IService<Author>, Service<Author>>();
